...
/**
*/
class QubeChorusflangerAudioProcessor  : public AudioProcessor
{
public:
    //==============================================================================
    QubeChorusflangerAudioProcessor();
    ~QubeChorusflangerAudioProcessor();
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (QubeChorusflangerAudioProcessor)
};
